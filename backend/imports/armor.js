...
module.exports = class Armor extends Item{
    constructor({name, type, level, baseProtection, imageLocation, tradeable = true, protectionMultiplier = 1.1, costMultiplier = 1.2}){
        super({name, type, level, imageLocation, stackable:false, tradeable});
